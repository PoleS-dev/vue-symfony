<template>
  <div v-if="course">
    <CourseDetail 
      ...
      icon-class="fab fa-vuejs"
    />
  </div>
  <div v-else-if="loading" class="loading-container">
    <div class="loading-spinner">
      <i class="fab fa-vuejs spinning"></i>
...
import vueCoursesData from '../data/vue-courses.json'
...
const loadCourse = () => {
  ...
  allCourses.value = vueCoursesData.courses.map(c => ({
    id: c.id,
    title: c.title,
    page: { slug: `/vue/${c.id}` },
    category: c.category,
