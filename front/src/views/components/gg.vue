<template>
    ...
    >
      ...
      <nav
        ...
        :class="[
          'md:p-5 xl:w-1/5 fixed z-10 transition-transform duration-300 ease-in-out',
          isMdOuPlus
            ? 'flex left-0 top-0  flex-col w-1/4 translate-x-0'
            : isMenuOpen
      ...
      >
        ...
        >
          ...
          <div class="right-0 md:max-h-[15rem] div-scrollbar overflow-y-auto ">
            ...
            >
              <div
                class="p-2 md:w-2/3 md:mt-1 md:text-start md:bg-transparent md:text-white border-b max-md:hover:bg-indigo-200 border-b-blue-300 border-t-blue-300 bg-indigo-100 text-xl border-t"
              >
                {{ group.label }} :
              </div>
  
              <button
                class=" max-md:w-full md:rounded-2xl md:ml-10 flex hover:bg-gray-300 bg-gray-100 flex-col gap-2"
        ...
        <div
          ...
          class="p-4 bg-gray-100 w-96rounded-xl my-4"
        >
